...
The designed balun with simultaneously terminated outputs presents a maximum mismatch of \SI{0.15}{\decibel} and \SI[separate-uncertainty=true]{-1.5 \pm 1.5}{\degree} in the \SIrange{100}{200}{\giga\hertz} range.
...
Results obtained by simulating one electromagnetic termination at a time are presented for measurement purposes. Over the \SIrange{100}{200}{\giga\hertz} bandwidth, the balun shows a maximum amplitude imbalance of \SI[separate-uncertainty=true]{\pm 1}{\decibel} and a maximum phase imbalance of \SI[separate-uncertainty=true]{\pm 6}{\degree}. This discrepancy is caused by unbalanced single-ended terminations, which generate mixed-mode conversion.\\
