...
The requirements seems to be met as the amplitude imbalance is within \SI{\pm 0.2}{\decibel} while the phase imbalance is contained in a range of \SI{\pm 1}{\degree}  with an offset of $-1^{\circ}$ in a band of frequencies between \SI{100}{\giga\hertz} and \SI{100}{\giga\hertz}.\\
%
\begin{figure}[hbt!]
    \centering
...
The Amplitude imbalance is now within \SI{\pm 1.2}{\decibel} meanwhile the phase imbalance is \SI{\pm 5}{\degree}.
\begin{figure}[hbt!]
    \centering
    \begin{subfigure}{0.49\textwidth}
        \centering
