...
The design aims to realize an active balun supplied from a \SI{1.8}{\volt} source, with amplitude and phase imbalances equal to or lower than $\pm 0.1\,\si{\decibel}$ and $\pm 1^{\circ}$, respectively, while remaining efficient and providing gain over the D-band. Although intended for D-band applications, the results are shown over the \SIrange{100}{200}{\giga\hertz} range to provide a more complete overview of its frequency behavior.\\
...
By implementing a shunt capacitor $C_1$ at the base of Q4, a CB topology is created, making it possible to keep its AC base voltage fixed at ground. In the design phase, a preliminary value of \SI{1}{\pico\farad} was chosen to obtain a low impedance at the base of Q4.
