...
\begin{figure}[hbt!]
    \centering
    \includegraphics[width=0.65\linewidth]{Design_figures/Layout/ComparisonMeasurements/ComparisonFirstStage_IdealvsEM_Admittances_FirstStageIdeal.png}
...
\end{figure}\\
As a first approximation, the second term can be evaluated by neglecting the $\frac{Y_{31}}{Y_{21}}Y_{23}$ and $\frac{Y_{21}}{Y_{31}}Y_{23}$ terms.
...
\begin{figure}[hbt!]
    \centering
    \includegraphics[width=0.65\linewidth]{Design_figures/Layout/ComparisonMeasurements/ComparisonFirstStage_IdealvsEM_Admittances_FirstStageEM.png}
...
\end{figure}\\
While keeping the approximations on the $\frac{Y_{31}}{Y_{21}}Y_{23}$ and $\frac{Y_{21}}{Y_{31}}Y_{32}$ terms, important differences can be observed. First, the trend of $|Y_{21}/Y_{31}|_{\mathrm{dB}}$ is no longer monotonic, with $Y_{31}$ that becomes greater than $Y_{21}$ above \SI{150}{\giga\hertz}.
...
\begin{figure}[!hbt]
    ...
    \begin{tikzpicture}
        ...
        \node (img) at (0,0) {\includegraphics[width=0.95\linewidth]{Design_figures/Layout/Layout3StageMerged_noMN/Layout_3StageMerged_noMN.png}};
...
\begin{figure}[hbt!]
    \centering
    \includegraphics[width=0.65\linewidth]{Design_figures/Layout/Layout3StageMerged_noMNMeasurements/ConnectedCores_Gain.png}
